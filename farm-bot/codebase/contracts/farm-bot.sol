...
contract FarmBot {
    mapping(address => uint256) private fpBalances; // maps address to "Farm Point" balances.
    ...
    uint256 lpTotalBalance; // total number of LP tokens owned by Farm Bot
    uint256 fpTotalBalance; // total number of "Farm Points" issued by Farm Bot
